        ...
        {products.map((p, i) => (
          <Link key={p.id} to={`/product/${p.id}`}>
            ...
            >
              ...
              <div className="p-3">
                <p className="text-slate-400 text-[10px] uppercase tracking-widest mb-0.5 truncate" style={{ fontFamily: 'var(--font-mono)' }}>
                  {p.name}
                </p>
                <p className="text-slate-900 font-semibold text-sm leading-tight line-clamp-1">{p.nameHe}</p>
                <p className="text-violet-600 font-bold text-sm mt-1.5" style={{ fontFamily: 'var(--font-mono)' }}>
